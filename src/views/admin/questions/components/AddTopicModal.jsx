...
export default function AddTopicModal({ skillsOptions }) {
            ...
            <div className="relative w-full max-w-xl mx-auto">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid rounded-t border-slate-200">
                  <h3 className="text-3xl font-semibold ">Add New Topic</h3>
                  <button
                  ...
                  <Formik
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      ...
                      try {
                        ...
                        toast.error("Sorry the new topic cannot be added!", {
                          // position: "top-right",
                          onClose: () => {
                            setIsSubmitting(false);
                            setShowModal(false);
                    ...
                    {({
                      ...
                      <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-3">
                          {
                            <div>
                              <p className="pb-4 font-bold">Skill</p>
                              <Field name="skillId">
                                {({ field }) => (
                                  <Select
                        ...
                        <button
                          ...
                          className="w-full px-3 py-3 text-white bg-custom-primaryColor"
                        >
                          {isSubmitting ? "Adding..." : "Add New Topic"}
                        </button>
                      </form>
                    )}
                  </Formik>
